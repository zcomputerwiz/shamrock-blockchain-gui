...
import { CardHero, Flex, Link } from '@shamrock/core';
import { PlotHero as PlotHeroIcon } from '@shamrock/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn shamrock. '
              }
              <Link
                target="_blank"
                href="https://github.com/Shamrock-Network/shamrock-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
