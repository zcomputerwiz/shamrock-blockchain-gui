...
import { CardHero, Flex, Link } from '@replaceme/core';
import { PlotHero as PlotHeroIcon } from '@replaceme/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn replaceme. '
              }
              <Link
                target="_blank"
