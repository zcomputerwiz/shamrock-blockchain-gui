...
import { Card, CopyToClipboard, Flex, Table } from '@shamrock/core';
import type { Row } from '../core/components/Table/Table';
import {
  clover_to_shamrock_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? clover_to_colouredcoin_string(row.amount)
        : clover_to_shamrock_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => clover_to_shamrock_string(row.fee_amount),
