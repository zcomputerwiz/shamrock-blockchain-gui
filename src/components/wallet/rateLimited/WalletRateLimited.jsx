...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const shamrockper_input = ip_parsed.limit;
    ...
    const shamrockper_value = Number.parseInt(Number(shamrockper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (shamrock per interval):{' '}
                  {clover_to_shamrock_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
