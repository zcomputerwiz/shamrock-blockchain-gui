...
import {
  ...
  Fee,
  Form,
  TextField as ShamrockTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of shamrock in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of shamrock that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and shamrock that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send shamrock to coloured address. Please enter a shamrock
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'shamrock_addr://') {
